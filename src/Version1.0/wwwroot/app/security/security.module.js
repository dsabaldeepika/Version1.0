(function() {
    ...
    security.config([
        '$httpProvider', '$routeProvider', 'accountResourceProvider', 'guardServiceProvider', 'baseUrl', function($httpProvider, $routeProvider, accountResourceProvider, guardServiceProvider, baseUrl) {
            ...
            $routeProvider.when('/register', {
                ...
                .when('/manage', {
                    ...
                    resolve: {
                        guard: [
                            'guardService', function(guardService) {
                ...
                .when('/externalregister', {
                    ...
                    resolve: {
                        appReady: [
                            'appStatusService', function(appStatusService) {
    ...
    security.run([
        'externalAuthService', 'restoreUserService', 'appStatusService', function(externalAuthService, restoreUserService, appStatusService) {
